...
main:
    ...
    movlw 0b00101001 ; first four zeros are irrelevent. 
...
mainloop:
poll: ; polls pin 5 for a button push
    btfss GP5 
    goto poll
    
    movlw 20 ; debounce delay
    call delay
    ...
    ;testing the lsb (should be more or less random)
    btfsc ADRESL, 6 
    bsf GP2
    btfsc ADRESL, 6 
    bcf GP1
